...
class OwnerSDJpaServiceTest {
    ...
    public static final String LAST_NAME = "Bartsotas";
    public static Owner returnOwner;
    @Mock
    ...
    void findByLastName() {
        ...
        Owner bar = service.findByLastName(LAST_NAME);
        assertEquals(LAST_NAME, bar.getLastName());
